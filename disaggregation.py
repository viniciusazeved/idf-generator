"""
Coeficientes de desagregacao de chuva — tabela nacional DNAEE.

Referencia: Tabela nacional de desagregacao de chuvas do antigo DNAEE,
reproduzida em CETESB (1980), Tucci (2009) e outros manuais brasileiros.
Fator 1.14 (dia fixo -> dia movel): Weiss, L. (1964). Ratio of true to
fixed-interval maximum rainfall. Journal of the Hydraulic Division, 90(1), 77-82.
"""

# Coeficientes de desagregacao: (duracao_origem_min, duracao_destino_min) -> coeficiente
# Fonte: tabela nacional do antigo DNAEE, reproduzida em CETESB (1980) e Tucci (2009).
# Cadeia: dia -> 1440min (*1.14) -> duracoes via 1440 -> 60min -> 120/30 -> subdivisoes de 30
DNAEE_COEFFICIENTS: dict[tuple[int, int], float] = {
    # Dia para 24h (fator de correcao dia fixo -> dia movel; Weiss, 1964)
    (1440, 1440): 1.14,
...
def disaggregate_24h(rainfall_1day_mm: float) -> dict[int, float]:
    ...
    A cadeia de desagregacao segue a tabela nacional DNAEE:
    ...
    # Passo 1: dia -> 1440min
    p1440 = rainfall_1day_mm * DNAEE_COEFFICIENTS[(1440, 1440)]
    depths[1440] = p1440
    ...
    p60 = depths[60]
    depths[120] = p60 * DNAEE_COEFFICIENTS[(60, 120)]
    depths[30] = p60 * DNAEE_COEFFICIENTS[(60, 30)]
